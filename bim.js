...
const buildingData = {
    ...
    residential: {
        ...
        content: `<ul class="space-y-4">
                    <li class="flex items-start gap-3"><div class="mt-1 p-1 bg-primary/10 rounded text-primary"><i data-lucide="bed-double" class="w-4 h-4"></i></div><span>Suites privées (SDB avec toilette/douche, Walk-in, Chambre, Grand Balcon)</span></li>
    ...
    coworking: {
        ...
        content: `<ul class="space-y-4">
                    ...
                    <li class="flex items-start gap-3"><div class="mt-1 p-1 bg-primary/10 rounded text-primary"><i data-lucide="door-open" class="w-4 h-4"></i></div><span>Sas d'entrée (Vestiaire souliers/manteaux)</span></li>
                </ul>`,
        icon: "briefcase"
    },
    rdc: {
    ...
    basement: {
        ...
        content: `<ul class="space-y-4">
                    ...
                    <li class="flex items-start gap-3"><div class="mt-1 p-1 bg-primary/10 rounded text-primary"><i data-lucide="package" class="w-4 h-4"></i></div><span>Espace de stockage (vélos et effets personnels encombrants)</span></li>
    ...
    engineering: {
        ...
        content: `<ul class="space-y-4">
                    ...
                    <li class="flex items-start gap-3"><div class="mt-1 p-1 bg-primary/10 rounded text-primary"><i data-lucide="settings" class="w-4 h-4"></i></div><span>Mécanique du bâtiment (HVAC)</span></li>
