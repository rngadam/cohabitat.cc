...
const buildingData = {
    ...
    residential: {
        ...
        content: `<ul class="space-y-4">
                    <li class="flex items-start gap-3"><div class="mt-1 p-1 bg-primary/10 rounded text-primary"><i data-lucide="bed-double" class="w-4 h-4"></i></div><span>Suites privées : Chambre, salle de bain (toilette/douche), walk-in closet et grand balcon</span></li>
    ...
    basement: {
        ...
        content: `<ul class="space-y-4">
                    ...
                    <li class="flex items-start gap-3"><div class="mt-1 p-1 bg-primary/10 rounded text-primary"><i data-lucide="bike" class="w-4 h-4"></i></div><span>Garage vélos et espace de stockage (effets personnels encombrants)</span></li>
    ...
    engineering: {
        ...
        content: `<ul class="space-y-4">
                    ...
                    <li class="flex items-start gap-3"><div class="mt-1 p-1 bg-primary/10 rounded text-primary"><i data-lucide="fan" class="w-4 h-4"></i></div><span>Mécanique (HVAC)</span></li>
